...
public class ThirdUseCase extends BaseTest{
    ...
    @Test(dataProvider = "TestData",dataProviderClass = Credentials.class)
    public void VerifyThePriceFilterOnProductsPage_SauceDemoTest(String userName, String password, String productName) {

                new SauceLoginPage(driver)
                .goToSauceLoginPage()
                .loginUser(userName,password)
                .verifyInventoryPageIsOpen()
                .selectPriceFilterLowToHigh()
                .verifyItemsAreListedLowToHigh()
                .selectPriceFilterHighToLow()
                .verifyItemsAreListedHighToLow()
                .logOut();
